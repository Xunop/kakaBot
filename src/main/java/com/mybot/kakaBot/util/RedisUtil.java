...
public class RedisUtil {
    private static final String prefix = "LEC:";
    ...
    public boolean setnx(String key, Object value, long time, TimeUnit timeUnit) {
        try {
            return Optional
                    .ofNullable(redisTemplate.opsForValue().setIfAbsent(prefix + key, value, time, timeUnit))
                    .orElse(false);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public long increase(String key, long delta) {
        ...
        return Optional.ofNullable(redisTemplate.opsForValue().increment(prefix + key, delta))
                .orElse(0L);
    }
    ...
    public boolean sHasKey(String key, Object value) {
        try {
            return Optional.ofNullable(redisTemplate.opsForSet().isMember(prefix + key, value))
                    .orElse(false);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public long sSet(String key, Object... values) {
        try {
            return Optional.ofNullable(redisTemplate.opsForSet().add(prefix + key, values))
                    .orElse(0L);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
    ...
    public long sGetSetSize(String key) {
        try {
            return Optional.ofNullable(redisTemplate.opsForSet().size(prefix + key))
                    .orElse(0L);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
    ...
    public long setRemove(String key, Object... values) {
        try {
            return Optional.ofNullable(redisTemplate.opsForSet().remove(prefix + key, values))
                    .orElse(0L);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
    ...
    public long lGetListSize(String key) {
        try {
            return Optional.ofNullable(redisTemplate.opsForList().size(prefix + key))
                    .orElse(0L);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
    ...
    public long lRemove(String key, long count, Object value) {
        try {
            return Optional.ofNullable(redisTemplate.opsForList().remove(prefix + key, count, value))
                    .orElse(0L);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
